...
%% Locate transcript for both undergrad and graduate 
    ...
    \textbf{NSF REU} - Implemented a Monte Carlo modeler for kinesin processivity
    ...
    \textbf{PHY506} Implemented a cellular automata traffic simulator in Python to investigate phase transitions of traffic flow
    \textbf{PHY515} Parallelized my dissertation utilizing ScaLAPACK
    \textbf{CSE536} Created a 2-dimensional hydrophoic-polar (2D HP) protein folder utilizing an Ant Colony Optimization Algorithm in Python
